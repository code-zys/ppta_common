...
class MissionCreateDto(BaseModel):
    ...
    duration: Optional[int] = Field(..., ge=1, description="Duration of the mission")
    duration_type: Optional[DurationType] = Field(..., description="Duration type: DAYS, MONTHS, YEARS")
