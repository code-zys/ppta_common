...
class MemberDto(BaseModel):
    ...
    firstname: str=Field(None, description="The first name of the legar representant")
    lastname: str=Field(None, description="The last name of the legar representant")
