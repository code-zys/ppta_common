...
class NotificationType(str, Enum):
    ...
    CONFIRMED_COACHING_SUCCESS = 'CONFIRMED_COACHING_SUCCESS'
    SESSION_PAYMENT_SUCCESS = 'SESSION_PAYMENT_SUCCESS'
    CONFIRMED_SESSION_SUCCESS = 'CONFIRMED_SESSION_SUCCESS'
    WITHDRAWAL_REQUEST = 'WITHDRAWAL_REQUEST'
    WITHDRAWAL_CONFIRMATION = 'WITHDRAWAL_CONFIRMATION'
    COACH_CANCELLED_SESSION = 'COACH_CANCELLED_SESSION'
    UNSUCESSFUL_PAYMENT = 'UNSUCESSFUL_PAYMENT'
    PROFILE_VERIFIED = 'PROFILE_VERIFIED'
    WORKPLACE_VERIFIED = 'WORKPLACE_VERIFIED'
    PROFILE_DISABLED = 'PROFILE_DISABLED'
    ADD_PARTICIPANTS_PAYMENT_SUCCESS = 'ADD_PARTICIPANTS_PAYMENT_SUCCESS'
    COACHING_CREATED = 'COACHING_CREATED'
    ADDED_NEW_PARTICIPANTS = 'ADDED_NEW_PARTICIPANTS'
