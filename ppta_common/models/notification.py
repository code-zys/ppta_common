...
class NotificationType(str, Enum):
    ...
    NEW_INTERNAL_CONSULTANT_INVITATION_PENDING = 'NEW_INTERNAL_CONSULTANT_INVITATION_PENDING'
    NEW_EXTERNAL_CONSULTANT_INVITATION_PENDING = 'NEW_EXTERNAL_CONSULTANT_INVITATION_PENDING'
